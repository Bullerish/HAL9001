...
| `SelfModel.cs` | **Self-model**: answers "what am I / can I do / know / have done?" from real state (registry + facts + event log), rendered by code. Topic chosen by the router's new `self` action. |
